...
export default React.createClass({
    ...
    fetch() {
        ...
        // Utils.ajaxData({
        //     url: '/modules/manage/deviceBaseInfo/deviceList.htm',
        //     method: "post",
        //     callback: (result) => {
                ...
                <div className="block-panel">
                    ...
                    <div className='blk-top'>
                        <div className='blk-top-item'>
                            ...
                            <div className='blk-top-item blk-top-item-last'>
                                <div className='blk-title'>老用户</div>
                                <div className='blk-number'>{data.a}</div>
                            </div>
                            <div className='blk-top-item'>
                                <div className='blk-title'>新用户</div>
                                <div className='blk-number'>{data.b}</div>
                            </div>
                            <div className='blk-top-item blk-top-item-last'>
                            ...
                            <div className='blk-top-item blk-top-item-last'>
                                <div className='blk-title'>老用户</div>
                                <div className='blk-number'>{data.c}</div>
                            </div>
                            <div className='blk-top-item'>
                                <div className='blk-title'>新用户</div>
                    ...
                    <div className='blk-top'>
                        ...
                        <div className='blk-top-item blk-top-item-last'>
                            <div className='blk-title'>老用户</div>
                            <div className='blk-number'>{data.m}</div>
                        </div>
                        <div className='blk-top-item'>
                            <div className='blk-title'>新用户</div>
                            <div className='blk-number'>{data.n}</div>
                        </div>
                        <div className='blk-top-item blk-top-item-last' >
