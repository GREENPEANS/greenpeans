        ...
        render(text, record) {
          return <div style={{ textAlign: "left" }}>
            <Tooltip placement="bottomLeft" title="修改" >
              <Button className="audit"  onClick={me.showModal.bind(null, '修改', record, true) }><i className="icon iconfont icon-wendangxiugai"></i></Button>
            </Tooltip>
            ...
            <Tooltip placement="bottomLeft" title="删除" >
              <Button className="delete" onClick={me.delete.bind(null, record) }><i className="icon iconfont icon-shanchu1"></i></Button>
            </Tooltip>
            <span className="ant-divider"></span>
            {/* <a href="#" onClick={me.showAssignModal.bind(null, '分配权限', record) }>分配权限</a> */}
            <Tooltip placement="bottomLeft" title="分配权限" >
              <Button onClick={me.showAssignModal.bind(null, '分配权限', record) }><i className="icon iconfont icon-quanxian"></i></Button>
            </Tooltip>
          </div>
        }
      }];
