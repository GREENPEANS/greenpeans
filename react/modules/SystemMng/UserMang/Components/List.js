  ...
  render() {
    ...
    var columns = [{
      ...
      render(text, record) {
        ...
        <Tooltip placement="bottomLeft" title="重置密码" >
          <Button className="zise" onClick={me.reset.bind(me,'重置密码',record)}><i className="icon iconfont icon-xiugaimima01"></i></Button>
        </Tooltip>
        <span className="ant-divider"></span>
        {record.status == '1' ?(<Tooltip placement="bottomLeft" title="解锁" ><Button  onClick={me.changeStatus.bind(me,'解锁',record)}><i className="icon iconfont icon-unlock"></i></Button></Tooltip>)
        :(<Tooltip placement="bottomLeft" title="锁定" ><Button onClick={me.changeStatus.bind(me,'锁定',record)}><i className="icon iconfont icon-lock"></i></Button></Tooltip>)}
        </div>
      }
    }];
