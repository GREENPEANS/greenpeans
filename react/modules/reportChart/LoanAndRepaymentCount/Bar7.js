...
export default React.createClass({
	...
	fetch(data) {
		...
		var data1 = [];
		var data2 = [];
		var jiekuan = data.loanBiRepaymentLeiji[0];
		//累计借款排序
		var b1 = [];
		var b2 = [];
	...
	drawBar() {
		var me = this;
		var bar = echarts.init(document.getElementById('bar7'),'macarons');
		var option = {
			title: {
				text: '当日累计放款:当日累计借款',
				x: 'center',
	...
	render() {
		return <div id="bar7" style={{ height: '400px', width: '700px', margin: '0 auto'  }}></div>
	}
});