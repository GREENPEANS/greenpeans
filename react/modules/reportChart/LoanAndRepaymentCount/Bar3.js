...
export default React.createClass({
	...
	fetch(data) {
		...
		var data2 = [];
		var data3 = [];
		var zhuce = data.loanAndRepaymentLeijiCount[0];
		var jiekuan = data.loanAndRepaymentLeijiCount[1];
		var fangkuan = data.loanAndRepaymentLeijiCount[2];
		//注册排序
		var a1 = [];
		var a2 = [];
	...
	render() {
		return <div id="bar3" style={{ height: '400px', width: '700px', margin: '0 auto'  }}></div>
	}
});