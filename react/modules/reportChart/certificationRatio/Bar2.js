...
export default React.createClass({
	...
	fetch(data) {
		 ...
		 * 全部认证比例
		 */
		for (let item in data.allGrandtotalScale) {
		...
		for (var i = 0; i < item1_allScale.length; i++) {
			data1_allScale.push(data.allGrandtotalScale[item2_allScale[i]]);
		}
		/**
		 * 芝麻信用比例
		 */
		for (let item in data.zhimaGrandtotalScale) {
		...
		for (var i = 0; i < item1_zhimaScale.length; i++) {
			data1_zhimaScale.push(data.zhimaGrandtotalScale[item2_zhimaScale[i]]);
		}
		/**
		 * 手机运营商比例
		 */
		for (let item in data.phoneGrandtotalScale) {
		...
		for (var i = 0; i < item1_phoneScale.length; i++) {
			data1_phoneScale.push(data.phoneGrandtotalScale[item2_phoneScale[i]]);
		}
		/**
		 * 银行卡比例
		 */
		for (let item in data.bankGrandtotalScale) {
		...
		for (var i = 0; i < item1_bankCardScale.length; i++) {
			data1_bankCardScale.push(data.bankGrandtotalScale[item2_bankCardScale[i]]);
		}
		/**
		 * 紧急联系人比例
		 */
		for (let item in data.contactGrandtotalScale) {
		...
		for (var i = 0; i < item1_contactScale.length; i++) {
			data1_contactScale.push(data.contactGrandtotalScale[item2_contactScale[i]]);
		}
		/**
		 * 实名认证比例
		 */
		for (let item in data.idGrandtotalScale) {
		...
		for (var i = 0; i < item1_idScale.length; i++) {
			data1_idScale.push(data.idGrandtotalScale[item2_idScale[i]]);
		}
